...
export function GridScan({
  ...
  useEffect(() => {
    ...
    if (bloomRef.current) {
      ...
      ;(bloomRef.current as BloomEffect & { luminanceMaterial: { threshold: number; smoothing: number } }).luminanceMaterial.threshold =
        bloomThreshold
      ;(bloomRef.current as BloomEffect & { luminanceMaterial: { threshold: number; smoothing: number } }).luminanceMaterial.smoothing =
        bloomSmoothing
    }
